...
public class EmployeeTest {
    ...
    void testingConstructorSuccess() {
        employee = new Employee("Mr", "Ruairi Doherty", "NZ23AMZ3", "Contract", "33 Briarhill", "wow@gmail.com",123456789,23, 20000);
        ...
        assertEquals("wow@gmail.com", employee.getEmail());
    }

    @DisplayName("Testing invalid salary entry")
    @Test
    void testingInvalidSalary() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> employee = new Employee("Mr", "Ruairi Doherty", "NZ23AZ23", "Contract", "11 Salthill","wow@gmail.com", 123456789,19, 2.111));
    ...
    void testingInvalidPPS() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> employee = new Employee("Mr", "Ruandria", "NZ", "Contract", "94 Claremorris","wow@gmail.com", 123456789,23, 2000));
    ...
    void testingInvalidType() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> employee = new Employee("Mr", "Ruairi Doherty", "NZ23AM23", "none", "69 GMIT","wow@gmail.com", 123456789, 23, 2000));
    ...
    void testingInvalidAge() {
        Exception e = assertThrows(IllegalArgumentException.class, () -> employee = new Employee("Mr", "Ruairi Doherty", "NZ23AZ23", "Contract", "11 Salthill","wow@gmail.com", 123456789,13, 2000));
